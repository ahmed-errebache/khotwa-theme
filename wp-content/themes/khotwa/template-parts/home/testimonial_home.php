                            ...
                            <div class="swiper-slide">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 text-center position-relative">
                                        <div class="testimonial_bloc_img mb-5" data-aos="fade-right" data-aos-delay="300">
                                    ...
                                    <div class="col-md-8 align-self-start testimonial-info">
                                        <div class="testimonial-information" data-aos="fade-left" data-aos-delay="300">
                                            <?php if (!empty($student_name)) : ?>
