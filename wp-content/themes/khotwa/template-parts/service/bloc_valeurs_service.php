...
$img_valeurs = is_array($valeurs_image) && isset($valeurs_image['url'])
    ? esc_url($valeurs_image['url'])
    : esc_url($valeurs_image);
?>
...
<section
  class="valeurs-section py-5 <?= esc_attr($direction_class); ?>"
  data-aos="fade-up"
    ...
    >
      ...
      <div class="col-lg-6 mobile">
        <?php if ( $img_valeurs ): ?>
          <img
            src="<?= $img_valeurs ?>"
            alt="Image des valeurs"
            class="img-fluid rounded mx-auto d-block img-valeur"
          >
        <?php endif; ?>
      </div>
      ...
      <div class="col-lg-6 pt-4">
        <?php if ( $valeurs_title ): ?>
          <h2 class="valeurs-title mb-5 fw-bold">
            <?= esc_html( $valeurs_title ); ?>
          </h2>
        <?php endif; ?>
                  ...
                  <?php foreach ( $valeurs_chunk as $valeur ): ?>
                    <div class="mb-4">
                      <h5 class="fw-bold mb-3">
                        <?= esc_html( $valeur['valeur_nom'] ); ?>
                      </h5>
                      <p class="mb-0">
                        <?= wp_kses_post( $valeur['valeur_description'] ); ?>
                      </p>
                    </div>
                  <?php endforeach; ?>
                </div>
